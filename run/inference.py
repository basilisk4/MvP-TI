...
def parse_args():
    ...
    parser.add_argument('--out',required=True ,type=str,
                        help='Path where output pickle is saved')
    ...
    if not args.data==None:
        config.DATASET.ROOT=args.data
        update_dir(False,False,False)
    return args
...
def main():
    ...
    print(os.path.join(final_output_dir, config.TEST.MODEL_FILE))
